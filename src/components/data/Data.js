    ...
    return (
        <div className={styles.section}>
            <div className={styles.list_grid}>
                ...
                <div className={styles.btn_item} onClick={handleToggle}>
                    ...
                    <button className={styles.btn} onClick={handleGrid}><BiGridSmall style={{ fontSize: '1.3rem' }}  />grid</button> */}
                        ...
                        <div className={styles.on}><svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="View grid">
